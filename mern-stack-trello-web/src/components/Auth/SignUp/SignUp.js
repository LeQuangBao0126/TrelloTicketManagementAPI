...
function SignUp() {
  ...
  const onSubmitSignUp = (data )=>{
    toast.promise(signUpUserAPI(data),{pending :'Signing up ...'}).then( user => navigate(`/signin?successEmail=${user.email}`,{replace:true}))
  }
        ...
        <div className="auth__form__input-field">
            ...
            <input 
                ...
                {...register('email',{
                    ...
                    pattern: {
                        value : EMAIL_RULE, message : EMAIL_RULE_MESSAGE
                    }
                })} 
            />
        </div>
        ...
        <div className="auth__form__input-field">
            ...
            <input 
                ...
                {...register('password', {
                    required : FIELD_REQUIRED_MESSAGE,
                    pattern: {
                        value : PASSWORD_RULE, message : PASSWORD_RULE_MESSAGE
                    }
                })}
            />
        </div>
